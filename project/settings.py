...
REPO_NAME = "webwonder"  # Used for FREEZER_BASE_URL
DEBUG = True
...
FREEZER_DESTINATION = PROJECT_ROOT # Since this is a repo page (not a Github user page), we need to set the BASE_URL to the correct url as per GH Pages' standards
...
####   OK so what the fuck  is this flat shit in here
